...
* `docs/constraints.adoc` with security constraint: "No dependency with a known CRITICAL or HIGH CVE may remain unpatched for more than 7 days"
* `docs/constraints.adoc` with licensing constraint: "Only MIT, Apache-2.0, and BSD-licensed dependencies are permitted"
