...
1. **needs-features** creates `docs/features/product-browsing/product-catalog.feature` and `product-search.feature` (prefix: PROD, 8 scenarios with @PROD-001 through @PROD-008 tags) + skeleton step definitions in `tests/features/product-browsing/steps/`
